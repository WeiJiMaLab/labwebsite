...
export default function People() {
    ...
    <Layout>
        ...
        <div className="banner people-list">
            ...
            />
            <h2 style={{ position: 'sticky', top: '60px', backgroundColor: 'white', zIndex: 1000 }}>Lab Members</h2>
            {filterPeople(currentLabMembers).map((person, index) => formatPeople(person, index))}
            
            <h2 style={{ position: 'sticky', top: '60px', backgroundColor: 'white', zIndex: 1000 }}>Alumni Collaborators</h2>
            {filterPeople(currentAlumniCollaborators).map((person, index) => formatPeople(person, index))}
            
            <h2 style={{ position: 'sticky', top: '60px', backgroundColor: 'white', zIndex: 1000 }}>External Collaborators</h2>
